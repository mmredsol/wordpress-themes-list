...
themes = [
            ...
            ('Twenty Twenty-One',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/twentytwentyone/1.1/screenshot.png?w=572&strip=all',
                              'https://wp-themes.com/twentytwentyone',
                              'https://downloads.wordpress.org/theme/twentytwentyone.1.1.zip',
            ...
            ('Twenty Twenty',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/twentytwenty/1.6/screenshot.png?w=572&strip=all',
                              'https://wp-themes.com/twentytwenty',
                              'https://downloads.wordpress.org/theme/twentytwenty.1.6.zip',
            ...
            ( 'Astra',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/astra/3.0.1/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/astra',
                              'https://downloads.wordpress.org/theme/astra.3.0.1.zip',
                              'https://wpastra.com/'),

            ( 'Hello Elementor',
                               'A plain-vanilla & lightweight theme for Elementor page builder',
                               'https://i0.wp.com/themes.svn.wordpress.org/hello-elementor/2.3.1/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/hello-elementor',
                               'https://downloads.wordpress.org/theme/hello-elementor.2.3.1.zip',
            ...
            ( 'Twenty Seventeen',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/twentyseventeen/2.5/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/twentyseventeen',
                               'https://downloads.wordpress.org/theme/twentyseventeen.2.5.zip',
            ...
            ( 'Twenty Nineteen',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/twentynineteen/1.9/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/twentynineteen',
                               'https://downloads.wordpress.org/theme/twentynineteen.1.9.zip',
                               'https://wordpress.org/themes/twentynineteen/'),

            ( 'PopularFX',
                               'Lightweight theme to make beautiful websites with Pagelayer. Includes 100s of pre-made templates to design your dream website !',
                               'https://i0.wp.com/themes.svn.wordpress.org/popularfx/1.1.9/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/popularfx',
                               'https://downloads.wordpress.org/theme/popularfx.1.1.9.zip',
                               'https://popularfx.com/'),
            ...
            ( 'OceanWP',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/oceanwp/2.0.2/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/oceanwp',
                               'https://downloads.wordpress.org/theme/oceanwp.2.0.2.zip',
                               'https://oceanwp.org/'),
            ...
            ( 'Kadence',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/kadence/1.0.11/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/kadence',
                               'https://downloads.wordpress.org/theme/kadence.1.0.11.zip',
            ...
            ( 'Neve',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/neve/2.9.5/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/neve',
                               'https://downloads.wordpress.org/theme/neve.2.9.5.zip',
            ...
            ( 'Go',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/go/1.3.9/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/go',
                               'https://downloads.wordpress.org/theme/go.1.3.9.zip',
                               'https://github.com/godaddy-wordpress/go'),

            ( 'Twenty Sixteen',
                               'Twenty Sixteen is a modernized take on an ever-popular WordPress layout — the horizontal masthead with an optional right sidebar that works perfectly for blogs and websites. It has custom color options with beautiful default color schemes, a harmonious fluid grid using a mobile-first approach, and impeccable polish in every detail. Twenty Sixteen will make your WordPress look beautiful everywhere.',
                               'https://i0.wp.com/themes.svn.wordpress.org/twentysixteen/2.3/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/twentysixteen',
                               'https://downloads.wordpress.org/theme/twentysixteen.2.3.zip',
            ...
            ( 'GeneratePress',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/generatepress/3.0.2/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/generatepress',
                               'https://downloads.wordpress.org/theme/generatepress.3.0.2.zip',
            ...
            ( 'Deep',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/deep/1.0.2/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/deep',
                               'https://downloads.wordpress.org/theme/deep.1.0.2.zip',
                               'https://webnus.net/deep-free-wordpress-theme/'),
            ...
            ( 'Hestia',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/hestia/3.0.8/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/hestia',
                               'https://downloads.wordpress.org/theme/hestia.3.0.8.zip',
            ...
            ( 'Colibri WP',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/colibri-wp/1.0.81/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/colibri-wp',
                               'https://downloads.wordpress.org/theme/colibri-wp.1.0.81.zip',
                               'https://colibriwp.com/go/colibri-theme/'),

            ( 'Storefront',
                               'Storefront is the perfect theme for your next WooCommerce project. Designed and developed by WooCommerce Core developers, it features a bespoke integration with WooCommerce itself plus many of the most popular customer facing WooCommerce extensions. There are several layout & color options to personalise your shop, multiple widget regions, a responsive design and much more. Developers will love its lean and extensible codebase making it a joy to customize and extend. Looking for a WooCommerce theme? Look no further!',
                               'https://i0.wp.com/themes.svn.wordpress.org/storefront/3.3.0/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/storefront',
                               'https://downloads.wordpress.org/theme/storefront.3.3.0.zip',
                               'https://woocommerce.com/storefront/'),

            ( 'Twenty Fifteen',
                               'Our 2015 default theme is clean, blog-focused, and designed for clarity. Twenty Fifteen\'s simple, straightforward typography is readable on a wide variety of screen sizes, and suitable for multiple languages. We designed it using a mobile-first approach, meaning your content takes center-stage, regardless of whether your visitors arrive by smartphone, tablet, laptop, or desktop computer.',
                               'https://i0.wp.com/themes.svn.wordpress.org/twentyfifteen/2.8/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/twentyfifteen',
                               'https://downloads.wordpress.org/theme/twentyfifteen.2.8.zip',
            ...
            ( 'Sydney',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/sydney/1.73/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/sydney',
                               'https://downloads.wordpress.org/theme/sydney.1.73.zip',
            ...
            ( 'Newsup',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/newsup/2.9.9.46/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/newsup',
                               'https://downloads.wordpress.org/theme/newsup.2.9.9.46.zip',
                               'https://themeansar.com/free-themes/newsup/'),

            ( 'Skyline WP',
                               'Skyline WP is a beautiful, very customizable, multipurpose theme that you can use to create amazing websites through drag and drop. It comes with a pre-designed home page, 5 header designs and over 35 ready-to-use content blocks that you can easily customize. You can also design your own custom blocks by combining more than 25 drag and drop components. Skyline WP offers lots of customization options (video background, slideshow background, header content types, etc) to help you create a website that stands out in no time. It is also designed with responsiveness, to work on mobile devices right out of the box. Skyline WP is the only theme you will ever need! CHECK OUT THE DEMOS: https://colibriwp.com/go/skyline-demos',
                               'https://i0.wp.com/themes.svn.wordpress.org/skyline-wp/1.0.3/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/skyline-wp',
                               'https://downloads.wordpress.org/theme/skyline-wp.1.0.3.zip',
            ...
            ( 'Signify Dark',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/signify-dark/1.0.4/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/signify-dark',
                               'https://downloads.wordpress.org/theme/signify-dark.1.0.4.zip',
                               'https://wenthemes.com/themes/signify-dark/'),
            ...
            ( 'Ashe',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/ashe/1.9.9/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/ashe',
                               'https://downloads.wordpress.org/theme/ashe.1.9.9.zip',
            ...
            ( 'Fairy',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/fairy/1.2.1/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/fairy',
                               'https://downloads.wordpress.org/theme/fairy.1.2.1.zip',
                               'https://www.candidthemes.com/themes/fairy'),
            ...
            ( 'OnePress',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/onepress/2.2.6/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/onepress',
                               'https://downloads.wordpress.org/theme/onepress.2.2.6.zip',
            ...
            ( 'Yummy Recipe',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/yummy-recipe/1.0.0/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/yummy-recipe',
                               'https://downloads.wordpress.org/theme/yummy-recipe.1.0.0.zip',
                               'https://blossomthemes.com/downloads/yummy-recipe/'),
            ...
            ( 'Customify',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/customify/0.3.5/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/customify',
                               'https://downloads.wordpress.org/theme/customify.0.3.5.zip',
                               'https://pressmaximum.com/customify'),
            ...
            ( 'ColorMag',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/colormag/2.0.4/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/colormag',
                               'https://downloads.wordpress.org/theme/colormag.2.0.4.zip',
            ...
            ( 'Twenty Twelve',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/twentytwelve/3.3/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/twentytwelve',
                               'https://downloads.wordpress.org/theme/twentytwelve.3.3.zip',
            ...
            ( 'Twenty Eleven',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/twentyeleven/3.6/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/twentyeleven',
                               'https://downloads.wordpress.org/theme/twentyeleven.3.6.zip',
            ...
            ( 'Rife Free',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/rife-free/2.4.11/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/rife-free',
                               'https://downloads.wordpress.org/theme/rife-free.2.4.11.zip',
                               'https://apollo13themes.com/rife/free/'),

            ( 'Calliope',
                               'Calliope is a beautiful, very customizable, multipurpose theme that you can use to create amazing websites through drag and drop. It comes with a pre-designed home page, 5 header designs and over 35 ready-to-use content blocks that you can easily customize. You can also design your own custom blocks by combining more than 25 drag and drop components. Calliope offers lots of customization options (video background, slideshow background, header content types, etc) to help you create a website that stands out in no time. It is also designed with responsiveness, to work on mobile devices right out of the box. Calliope is the only theme you will ever need! CHECK OUT THE DEMOS: https://colibriwp.com/go/calliope-demos',
                               'https://i0.wp.com/themes.svn.wordpress.org/calliope/1.0.26/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/calliope',
                               'https://downloads.wordpress.org/theme/calliope.1.0.26.zip',
                               'https://wordpress.org/themes/calliope/'),
            ...
            ( 'Occasio',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/occasio/1.0.3/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/occasio',
                               'https://downloads.wordpress.org/theme/occasio.1.0.3.zip',
                               'https://themezee.com/themes/occasio/'),
            ...
            ( 'Shapely',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/shapely/1.2.10/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/shapely',
                               'https://downloads.wordpress.org/theme/shapely.1.2.10.zip',
            ...
            ( 'Avril',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/avril/1.0.30/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/avril',
                               'https://downloads.wordpress.org/theme/avril.1.0.30.zip',
                               'https://www.nayrathemes.com/avril-free/'),
            ...
            ( 'Mesmerize',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/mesmerize/1.6.105/screenshot.jpg?w=572&strip=all',
                               'https://wp-themes.com/mesmerize',
                               'https://downloads.wordpress.org/theme/mesmerize.1.6.105.zip',
                               'https://extendthemes.com/go/mesmerize-home/'),
            ...
            ( 'Travel Nomad',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/travel-nomad/1.0.1/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/travel-nomad',
                               'https://downloads.wordpress.org/theme/travel-nomad.1.0.1.zip',
                               'https://blossomthemes.com/wordpress-themes/travel-nomad/'),

            ( 'Envo Shop',
                               'Envo Shop is a fast, clean and modern-looking responsive free WooCommerce WordPress theme. This theme supports popular page builders like Elementor, KingComposer, Beaver Builder, SiteOrigin, Thrive Architect, Divi, Brizy, Visual Composer, etc. Envo Shop is compatible with YITH WooCommerce Wishlist, YITH WooCommerce Compare, WooCommerce Variation Swatches and other popular plugins. The theme is SEO friendly, WPML and RTL ready. Documentation: https://envothemes.com/docs/docs/envo-shop/ Theme demo ready to import: https://envothemes.com/envo-shop/',
                               'https://i0.wp.com/themes.svn.wordpress.org/envo-shop/1.0.9/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/envo-shop',
                               'https://downloads.wordpress.org/theme/envo-shop.1.0.9.zip',
                               'https://envothemes.com/free-envo-shop/'),
            ...
            ( 'Newsberg',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/newsberg/1.4/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/newsberg',
                               'https://downloads.wordpress.org/theme/newsberg.1.4.zip',
                               'https://themeansar.com/free-themes/newsberg/'),
            ...
            ( 'Total',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/total/1.2.51/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/total',
                               'https://downloads.wordpress.org/theme/total.1.2.51.zip',
            ...
            ( 'PhotoFocus',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/photofocus/1.1.6/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/photofocus',
                               'https://downloads.wordpress.org/theme/photofocus.1.1.6.zip',
                               'https://catchthemes.com/themes/photofocus/'),
            ...
            ( 'Twenty Ten',
                               ...
                               'https://i0.wp.com/themes.svn.wordpress.org/twentyten/3.2/screenshot.png?w=572&strip=all',
                               'https://wp-themes.com/twentyten',
                               'https://downloads.wordpress.org/theme/twentyten.3.2.zip',
...
with open('1.json', 'w') as f:
  f.write(json.dumps(themes_list))
